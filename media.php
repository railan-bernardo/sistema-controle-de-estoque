...
<?php
  ...
  $photo->upload($_FILES['file_upload']);
    if($photo->process_media()){
        $session->msg('s','Imagem Salva na Galeria!');
        redirect('media.php');
    } else{
          ...
          <div class="panel-body">
            <table class="table">
              <thead>
                ...
                <td class="text-center">
                  <?php if($nivel <= 1): ?>
                  <a href="delete_media.php?id=<?php echo (int) $media_file['id'];?>" class="btn btn-danger btn-xs"  title="Excluir">
                    <span class="glyphicon glyphicon-trash"></span>
                  </a>
                <?php else: ?>
                  <a href="#" class="btn btn-danger btn-xs"  title="Sem Permissão">
