<?php
  $page_title = 'Adicionar Consultora';
...
<?php
 if(isset($_POST['add_saleswoman'])){
   ...
   if(empty($errors)){
     ...
     $query .=" name,city,uf,phone,cpf,adress,birthday";
     $query .=") VALUES (";
...
<div class="row">
  <div class="col-md-12">
    <?php echo display_msg($msg); if($validar){ var_dump($validar, 'valido'); }else if(empty($validar)){var_dump($validar, 'valido vazio');}else{var_dump($validar, 'invalido');} if(isset($_POST['cep'])): $sp = $_POST['ceps']; $ncep = getCep($sp); endif; ?>
  </div>
</div>
  <div class="row">
  <div class="col-md-9">
        ...
        <div class="panel-body">
         ...
         <div class="form-group">
          ...
          <form method="post" action="add_client.php" class="clearfix">
              ...
              <button type="submit" name="add_client" class="btn btn-primary" style="margin-top: 15px;">Cadastrar</button>
          </form>
         </div>
        </div>
      </div>
